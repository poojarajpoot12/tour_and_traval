...
import axios from 'axios'; // Update this path if needed
...
const EastIndia = () => {
  ...
  return (
    <div className="east-india-page">
      {/* Top Section */}
      <div className="top-section">
        <h1 className="main-heading">East India</h1>
        <p className="description">
          Discover the unexplored beauty of East India—from vibrant culture and wildlife to temples, hills, and beaches.
        </p>
      </div>
