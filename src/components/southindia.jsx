...
const SouthIndia = () => {
  ...
  useEffect(() => {
    if (selectedCategory) {
      axios
        .get(`https://your-backend-url.com/api/packages/category/${selectedCategory}`)
  ...
  return (
    <div className="south-india-page">
      {/* Top Section */}
      <div className="top-section">
        <h1 className="main-heading">South India</h1>
        <p className="description">
          Explore the serene backwaters, lush green hills, historic temples, and sun-kissed beaches of South India.
        </p>
      </div>
